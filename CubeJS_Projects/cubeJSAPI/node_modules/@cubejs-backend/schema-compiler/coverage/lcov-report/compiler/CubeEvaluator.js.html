...
<head>
    <title>Code coverage report for compiler/CubeEvaluator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">compiler</a> CubeEvaluator.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8933x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7524x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4339x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11498x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16669x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">17590x</span>
<span class="cline-any cline-yes">17590x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">17590x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">21541x</span>
<span class="cline-any cline-yes">21541x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">25644x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">25644x</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">15504x</span>
<span class="cline-any cline-yes">15504x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    this.primaryKeys = R.fromPairs(validCubes.map((v) =&gt; {
      const primaryKeyNameToSymbol = R.compose(R.find(d =&gt; d[1].primaryKey), R.toPairs)(v.dimensions || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
      return [
        v.name,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  cu</span>besByFileName(fileName) {
<span class="cstat-no" title="statement not covered" >    return this.byFileName[fileName] || [];</span>
  }
&nbsp;
  timeDimensionPathsForCube(cube) {
    ...
    )(this.evaluatedCubes[cube].dimensions || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  me</span>asuresForCube(cube) {
<span class="cstat-no" title="statement not covered" >    return this.cubeFromPath(cube).measures || {};</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  cu</span>beNamesWithRefreshKeys() {
<span class="cstat-no" title="statement not covered" >    return Object.keys(this.evaluatedCubes).filter(<span class="fstat-no" title="function not covered" >c </span>=&gt; <span class="cstat-no" title="statement not covered" >!!this.evaluatedCubes[c].refreshKey)</span>;</span>
  }
&nbsp;
...
&nbsp;
  cubeNameFromPath(path) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.evaluatedCubes[cubeAndName[0]]) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`Cube '${cubeAndName[0]}' not found for path '${path}'`);</span>
    }
...
<span class="cstat-no" title="statement not covered" >      throw new Error(`Type can't be undefined for '${path}'`);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!path) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Path can't be undefined`);</span>
    }
    const cubeAndName = Array.isArray(path) ? path : path.split('.');
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.evaluatedCubes[cubeAndName[0]]) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`Cube '${cubeAndName[0]}' not found for path '${path}'`);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.evaluatedCubes[cubeAndName[0]][type]) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`${type} not defined for path '${path}'`);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.evaluatedCubes[cubeAndName[0]][type][cubeAndName[1]]) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`'${cubeAndName[1]}' not found for path '${path}'`);</span>
    }

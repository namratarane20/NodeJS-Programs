...
<head>
    <title>Code coverage report for compiler/CubeToMetaTransformer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">compiler</a> CubeToMetaTransformer.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5884x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
    ...
    return {
      config: {
        ...
        measures: R.compose(
          ...
          R.toPairs
        )(cube.measures || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
        dimensions: R.compose(
          R.map((nameToDimension) =&gt; ({
            ...
            suggestFilterValues:
              nameToDimension[1].suggestFilterValues == null ? true : <span class="branch-1 cbranch-no" title="branch not covered" >nameToDimension[1].suggestFilterValues,</span>
          ...
          R.toPairs
        )(cube.dimensions || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
        segments: R.compose(
          R.map((nameToSegment) =&gt; ({
          ...
          R.toPairs
        )(cube.segments || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>
      }
    };
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  qu</span>eriesForContext(contextId) {
    // return All queries if no context pass
<span class="cstat-no" title="statement not covered" >    if (R.isNil(contextId) || R.isEmpty(contextId)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.queries;</span>
    }
&nbsp;
    const context = <span class="cstat-no" title="statement not covered" >this.contextEvaluator.contextDefinitions[contextId];</span>
&nbsp;
    // If contextId is wrong
<span class="cstat-no" title="statement not covered" >    if (R.isNil(context)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new UserError(`Context ${contextId} doesn't exist`);</span>
    }
&nbsp;
    // As for now context works on the cubes level
<span class="cstat-no" title="statement not covered" >    return R.filter(</span>
<span class="fstat-no" title="function not covered" >      (q</span>uery) =&gt; <span class="cstat-no" title="statement not covered" >R.contains(query.config.name, context.contextMembers)</span>
    )(this.queries);
  }
&nbsp;
  isVisible(symbol, defaultValue) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (symbol.visible != null) {
<span class="cstat-no" title="statement not covered" >      return symbol.visible;</span>
    }

...
<head>
    <title>Code coverage report for parser/SqlParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">parser</a> SqlParser.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>89/99</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3852x</span>
...
<span class="cline-any cline-yes">3852x</span>
<span class="cline-any cline-yes">3852x</span>
<span class="cline-any cline-yes">6358x</span>
<span class="cline-any cline-yes">3651x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">574x</span>
<span class="cline-any cline-yes">31294x</span>
...
<span class="cline-any cline-yes">977x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">30317x</span>
<span class="cline-any cline-yes">71x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">30317x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const antlr4 = require('antlr4');
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx.children) {
...
&nbsp;
  static sqlUpperCase(sql) {
    ...
    for (let i = 0; i &lt; sql.length; i++) {
      if (openChar) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (openChar === '\'' &amp;&amp; sql[i] === openChar &amp;&amp; sql[i + 1] === openChar) {
<span class="cstat-no" title="statement not covered" >          result += sql[i];</span>
<span class="cstat-no" title="statement not covered" >          i++;</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (openChar) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unterminated string: ${sql}`);</span>
    }
    return result;
  }
&nbsp;
  parse() {
    ...
    chars.getText = (start, stop) =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (stop &gt;= this._size) {
        // eslint-disable-next-line no-underscore-dangle
<span class="cstat-no" title="statement not covered" >        stop = this._size - 1;</span>
      }
      // eslint-disable-next-line no-underscore-dangle
      <span class="missing-if-branch" title="if path not taken" >I</span>if (start &gt;= this._size) {
<span class="cstat-no" title="statement not covered" >        return "";</span>
      } else {
...
&nbsp;
  throwErrorsIfAny() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.errors.length) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`SQL Parsing Error:\n${this.errors.map(<span class="fstat-no" title="function not covered" >({</span> msg, column, line }) =&gt; <span class="cstat-no" title="statement not covered" >`${line}:${column} ${msg}`)</span>.join('\n')}`);</span>
    }
  }
&nbsp;
    ...
    this.ast.accept(nodeVisitor({
      visitNode(ctx) {
        if (ctx instanceof QueryContext) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (selectItems.length === 1 &amp;&amp; selectItems[0].getText() === '*') {
            result = true;
          }
        }
      }
    ...
    const whereBuildingVisitor = nodeVisitor({
      visitNode(ctx) {
        if (ctx instanceof IdPathContext) {
          ...
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx.children.length === 1) {
            result += [tableAlias, '.'].concat(ctx.children.map(c =&gt; c.getText())).join('');
            cursor = ctx.stop.stop + 1;
          } else {
<span class="cstat-no" title="statement not covered" >            result += sql.substring(cursor, ctx.stop.stop);</span>
<span class="cstat-no" title="statement not covered" >            cursor = ctx.stop.stop;</span>
          }
        }
      }
    });
    ...
    this.ast.accept(nodeVisitor({
      visitNode(ctx) {
        if (ctx instanceof QueryContext &amp;&amp; ctx.from &amp;&amp; ctx.where) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (lastNode instanceof IdPathContext) {
            originalAlias = lastNode.children[lastNode.children.length - 1].getText();
          } else {
<span class="cstat-no" title="statement not covered" >            originalAlias = lastNode.getText();</span>
          }

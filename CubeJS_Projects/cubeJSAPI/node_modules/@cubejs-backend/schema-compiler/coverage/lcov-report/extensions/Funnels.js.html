...
<head>
    <title>Code coverage report for extensions/Funnels.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">extensions</a> Funnels.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  eventFunnel(funnelDefinition) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!funnelDefinition.userId || !funnelDefinition.userId.sql) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`userId.sql is not defined`); </span>// TODO schema check
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!funnelDefinition.time || !funnelDefinition.time.sql) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`time.sql is not defined`); </span>// TODO schema check
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!funnelDefinition.steps || !funnelDefinition.steps.length) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`steps are not defined`); </span>// TODO schema check
    }
&nbsp;
    ...
    ${funnelDefinition.steps.map(s =&gt; this.stepSegmentSelect(funnelDefinition, s)).join("\nUNION ALL\n")}
      ...
      measures: {
        ...
        firstStepConversions: {
          sql: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >`first_step_user_id`,</span>
          type: `countDistinct`,
          shown: false
        },
        conversionsPercent: {
          sql: <span class="fstat-no" title="function not covered" >(c</span>onversions, firstStepConversions) =&gt; <span class="cstat-no" title="statement not covered" >`CASE WHEN ${firstStepConversions} &gt; 0 THEN 100.0 * ${conversions} / ${firstStepConversions} ELSE NULL END`,</span>
          type: `number`,
          format: `percent`
        }
      },
&nbsp;
      dimensions: {
        id: {
          sql: <span class="fstat-no" title="function not covered" >(t</span>ime, step) =&gt; <span class="cstat-no" title="statement not covered" >`first_step_user_id || ${time} || ${step}`,</span>
          type: `string`,
          primaryKey: true
        },
        userId: {
          sql: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >`user_id`,</span>
          type: `string`,
          shown: false
        },
        firstStepUserId: {
        ...
        step: {
          sql: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >`step`,</span>
          type: `string`
        }
      }
    });
...
&nbsp;
  eventCubeJoin(funnelDefinition, step, prevStep) {
    ...
    const fromSql = (sql.indexOf('select') !== -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >`(${sql}) e` </span>: sql);

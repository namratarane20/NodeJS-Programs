...
<head>
    <title>Code coverage report for adapter/ParamAllocator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">adapter</a> ParamAllocator.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class ParamAllocator {
  constructor() {
    this.params = [];
  }
&nbsp;

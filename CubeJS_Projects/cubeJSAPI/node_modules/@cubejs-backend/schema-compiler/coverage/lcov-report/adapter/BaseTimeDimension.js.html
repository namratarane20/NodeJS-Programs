...
<head>
    <title>Code coverage report for adapter/BaseTimeDimension.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">adapter</a> BaseTimeDimension.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const momentRange = require('moment-range');
...
const TIME_SERIES = {
  ...
  year: <span class="fstat-no" title="function not covered" >(r</span>ange) =&gt; <span class="cstat-no" title="statement not covered" >Array.from(range.snapTo('year').by('year'))</span>
    .map(<span class="fstat-no" title="function not covered" >d </span>=&gt; <span class="cstat-no" title="statement not covered" >[d.format('YYYY-01-01T00:00:00.000'), d.endOf('year').format('YYYY-MM-DDT23:59:59.999')])</span>,
  hour: <span class="fstat-no" title="function not covered" >(r</span>ange) =&gt; <span class="cstat-no" title="statement not covered" >Array.from(range.snapTo('hour').by('hour'))</span>
    .map(<span class="fstat-no" title="function not covered" >d </span>=&gt; <span class="cstat-no" title="statement not covered" >[d.format('YYYY-MM-DDTHH:00:00.000'), d.format('YYYY-MM-DDTHH:59:59.999')])</span>,
  minute: <span class="fstat-no" title="function not covered" >(r</span>ange) =&gt; <span class="cstat-no" title="statement not covered" >Array.from(range.snapTo('minute').by('minute'))</span>
    .map(<span class="fstat-no" title="function not covered" >d </span>=&gt; <span class="cstat-no" title="statement not covered" >[d.format('YYYY-MM-DDTHH:MM:00.000'), d.format('YYYY-MM-DDTHH:MM:59.999')])</span>,
  second: <span class="fstat-no" title="function not covered" >(r</span>ange) =&gt; <span class="cstat-no" title="statement not covered" >Array.from(range.snapTo('second').by('second'))</span>
    .map(<span class="fstat-no" title="function not covered" >d </span>=&gt; <span class="cstat-no" title="statement not covered" >[d.format('YYYY-MM-DDTHH:MM:SS.000'), d.format('YYYY-MM-DDTHH:MM:SS.999')])</span>,
...
&nbsp;
  unescapedAliasName(granularity) {
    const actualGranularity = granularity || this.granularity || <span class="branch-2 cbranch-no" title="branch not covered" >'day';</span>
&nbsp;
...
&nbsp;
  dateSeriesSelectColumn(dateSeriesAliasName) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.granularity) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (context.ungrouped) {
<span class="cstat-no" title="statement not covered" >      return this.convertedToTz();</span>
    }
...
&nbsp;
  timeSeries() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.dateRange) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`Time series queries without dateRange aren't supported`);</span>
    }
    if (!this.granularity) {
      return [
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!TIME_SERIES[this.granularity]) {
<span class="cstat-no" title="statement not covered" >      throw new UserError(`Unsupported time granularity: ${this.granularity}`);</span>
    }

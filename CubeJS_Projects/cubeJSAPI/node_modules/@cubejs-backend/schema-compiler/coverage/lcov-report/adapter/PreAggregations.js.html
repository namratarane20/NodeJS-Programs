...
<head>
    <title>Code coverage report for adapter/PreAggregations.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">adapter</a> PreAggregations.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">86.29% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>170/197</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">84.76% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>89/105</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>152/177</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2703x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">889x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const R = require('ramda');
...
&nbsp;
    ...
    return R.pipe(
      R.map(cube =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (foundPreAggregation) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  st</span>atic transformedQueryToReferences(query) {
<span class="cstat-no" title="statement not covered" >    return {</span>
      measures: query.measures,
      dimensions: query.sortedDimensions,
      timeDimensions: query.sortedTimeDimensions.map(<span class="fstat-no" title="function not covered" >([</span>dimension, granularity]) =&gt; (<span class="cstat-no" title="statement not covered" >{ dimension, granularity })</span>)
    };
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ca</span>nUsePreAggregationAndCheckIfRefValid(query) {
    const transformedQuery = <span class="cstat-no" title="statement not covered" >PreAggregations.transformQueryToCanUseForm(query);</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(r</span>efs) =&gt; <span class="cstat-no" title="statement not covered" >PreAggregations.canUsePreAggregationForTransformedQueryFn(</span></span>
      transformedQuery, refs
    );
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  ch</span>eckAutoRollupPreAggregationValid(refs) {
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      this.autoRollupPreAggregationQuery(null, refs); </span>// TODO null
<span class="cstat-no" title="statement not covered" >      return true;</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >      if (e instanceof UserError || e.toString().indexOf('ReferenceError') !== -1) {</span>
...
&nbsp;
  static canUsePreAggregationForTransformedQueryFn(transformedQuery, refs) {
    function sortTimeDimensions(timeDimensions) {
      return timeDimensions &amp;&amp; R.sortBy(
<span class="fstat-no" title="function not covered" >        d </span>=&gt; <span class="cstat-no" title="statement not covered" >d.join('.'),</span>
        timeDimensions.map(d =&gt; [d.dimension, d.granularity || <span class="branch-1 cbranch-no" title="branch not covered" >'day']</span>)
      ) || <span class="branch-2 cbranch-no" title="branch not covered" >[];</span>
    }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (refs) {
<span class="cstat-no" title="statement not covered" >      return canUseFn(refs);</span>
    } else {
      return canUseFn;
    }
  }
...
&nbsp;
  // eslint-disable-next-line no-unused-vars
<span class="fstat-no" title="function not covered" >  ge</span>tCubeLattice(cube, preAggregationName, preAggregation) {
<span class="cstat-no" title="statement not covered" >    throw new UserError('Auto rollups supported only in Enterprise version');</span>
  }
&nbsp;
  ...
  findAutoRollupPreAggregationsForCube(cube, preAggregations) {
    if (
      ...
      return R.pipe(
        ...
        R.map(<span class="fstat-no" title="function not covered" >([</span>preAggregationName, preAggregation]) =&gt; {
          const cubeLattice = <span class="cstat-no" title="statement not covered" >this.getCubeLattice(cube, preAggregationName, preAggregation);</span>
          const optimalPreAggregation = <span class="cstat-no" title="statement not covered" >cubeLattice.findOptimalPreAggregationFromLattice(this.query);</span>
<span class="cstat-no" title="statement not covered" >          return optimalPreAggregation &amp;&amp; {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ro</span>llupMatchResultDescriptions() {
<span class="cstat-no" title="statement not covered" >    return this.rollupMatchResults().map(<span class="fstat-no" title="function not covered" >p </span>=&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ca</span>nUseTransformedQuery() {
<span class="cstat-no" title="statement not covered" >    return PreAggregations.transformQueryToCanUseForm(this.query);</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  au</span>toRollupPreAggregationQuery(cube, aggregation) {
<span class="cstat-no" title="statement not covered" >    return this.query.newSubQuery({</span>
      rowLimit: null,
...
&nbsp;
  mergePartitionTimeDimensions(aggregation, partitionTimeDimensions) {
    ...
    return aggregation.timeDimensions.map(d =&gt; {
      ...
      return toMerge ? Object.assign({}, d, { dateRange: toMerge.dateRange }) : <span class="branch-1 cbranch-no" title="branch not covered" >d;</span>
    });
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  au</span>toRollupNameSuffix(cube, aggregation) {
    // eslint-disable-next-line prefer-template
<span class="cstat-no" title="statement not covered" >    return '_' + aggregation.dimensions.concat(</span>
      aggregation.timeDimensions.map(<span class="fstat-no" title="function not covered" >d </span>=&gt; <span class="cstat-no" title="statement not covered" >`${d.dimension}${d.granularity.substring(0, 1)}`)</span>
    ).map(<span class="fstat-no" title="function not covered" >s </span>=&gt; {
      const path = <span class="cstat-no" title="statement not covered" >s.split('.');</span>
<span class="cstat-no" title="statement not covered" >      return `${path[0][0]}${path[1]}`;</span>
    }).map(<span class="fstat-no" title="function not covered" >s </span>=&gt; <span class="cstat-no" title="statement not covered" >s.replace(/_/g, ''))</span>.join("_")
      .replace(/[.]/g, '')
      .toLowerCase();
  }
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >      preAggregationForQuery.preAggregation.measures </span>:
      this.evaluateAllReferences(preAggregationForQuery.cube, preAggregationForQuery.preAggregation).measures);
&nbsp;
    const rollupGranularity = this.castGranularity(preAggregationForQuery.preAggregation.granularity) || <span class="branch-1 cbranch-no" title="branch not covered" >'day';</span>
&nbsp;
...
&nbsp;
    ...
    return `(${union})${withoutAlias ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: ' as partition_union'}`;
  }
}
&nbsp;

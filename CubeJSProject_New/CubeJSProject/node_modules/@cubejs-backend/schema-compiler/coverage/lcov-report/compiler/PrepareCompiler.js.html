...
<head>
    <title>Code coverage report for compiler/PrepareCompiler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">compiler</a> PrepareCompiler.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const CubeValidator = require('./CubeValidator');
...
&nbsp;
exports.compile = <span class="fstat-no" title="function not covered" >(r</span>epo, options) =&gt; {
  const compilers = <span class="cstat-no" title="statement not covered" >exports.prepareCompiler(repo, options);</span>
<span class="cstat-no" title="statement not covered" >  return compilers.compiler.compile().then(</span>
<span class="fstat-no" title="function not covered" >    ()</span> =&gt; <span class="cstat-no" title="statement not covered" >compilers</span>
  );
};
&nbsp;
